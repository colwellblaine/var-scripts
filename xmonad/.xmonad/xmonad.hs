...
--     , className =? "VirtualBox Manager" --> doShift  ( myWorkspaces !! 4 )
     ...
     , (className =? "calwidget" <&&> resource =? "Dialog") --> doFloat  -- Float Firefox Dialog
...
--        , ("C-e a", spawn (myEmacs ++ ("--eval '(emms)' --eval '(emms-play-directory-tree \"~/Music/Non-Classical/70s-80s/\")'")))
    ...
    -- Multimedia Keys
        ...
        , ("<XF86MonBrightnessUp>", spawn "brightnessctl s +12")
        , ("<XF86MonBrightnessDown>", spawn "brightnessctl s 12-")
        , ("S-<XF86MonBrightnessUp>", spawn "brightnessctl s +6;")
        , ("S-<XF86MonBrightnessDown>", spawn "brightnessctl s 6-")
        ]
